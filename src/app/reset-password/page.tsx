      ...
      <Card className="w-full max-w-sm liquid-glass liquid-glass-card rounded-2xl border-white/60 dark:border-white/10 shadow-2xl relative z-10 backdrop-blur-xl">
        <CardHeader className="space-y-3 pb-3 text-center">
          ...
          <div className="space-y-1 text-center">
            <CardTitle className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-primary via-sky-600 to-primary bg-clip-text text-transparent">
              Crear Nueva Contraseña
            </CardTitle>
            <CardDescription className="text-muted-foreground/90 font-medium text-xs">
              Introduce y confirma tu nueva clave de acceso segura
            </CardDescription>
          </div>
        </CardHeader>
